...
class Player:
    ...
    and that's okay
    '''
    def __init__(self, name='Joe', yards=125, touchdowns=3, safety=1,
                 interceptions=0, field_goals=2):
        self.name = name
        self.yards = yards
...
class Quarterback(Player):
    ...
    '''
    def __init__(self, name='Jim', yards=130, touchdowns=5, completed_passes=20,
